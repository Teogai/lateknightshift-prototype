...
export const CARD_DEFS = [
  ...
  { id: 'knight_power', name: 'Knight Power',   type: 'action', actionType: 'knight_power', rarity: 'common', image: './img/Chess_nlt60.png', desc: 'Apply {knight power} for 1 move.' },
  { id: 'bishop_power', name: 'Bishop Power',   type: 'action', actionType: 'bishop_power', rarity: 'uncommon', image: './img/Chess_blt60.png', desc: 'Apply {bishop power} for 1 move.' },
  { id: 'rook_power',   name: 'Rook Power',     type: 'action', actionType: 'rook_power', rarity: 'uncommon', image: './img/Chess_rlt60.png', desc: 'Apply {rook power} for 1 move.' },
  { id: 'queen_power',  name: 'Queen Power',    type: 'action', actionType: 'queen_power', rarity: 'rare', image: './img/Chess_qlt60.png', desc: 'Apply {queen power} for 1 move.' },
  { id: 'king_power',   name: 'King Power',     type: 'action', actionType: 'king_power', rarity: 'rare', image: './img/Chess_klt60.png', desc: 'Apply {king power} for 1 move.' },

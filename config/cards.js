...
export const CARD_DEFS = [
  ...
  { id: 'knight_move',  name: 'Knight Move',    type: 'move',   moveVariant: 'knight', rarity: 'common', inRewardPool: false, image: './img/Chess_nlt60.png', desc: '{Knight} jump to any square.' },
  { id: 'bishop_move',  name: 'Bishop Move',    type: 'move',   moveVariant: 'bishop', rarity: 'uncommon', inRewardPool: false, image: './img/Chess_blt60.png', desc: 'Move like {bishop}.' },
  { id: 'rook_move',    name: 'Rook Move',      type: 'move',   moveVariant: 'rook',   rarity: 'uncommon', inRewardPool: false, image: './img/Chess_rlt60.png', desc: 'Move like {rook}.' },
  { id: 'queen_move',   name: 'Queen Move',     type: 'move',   moveVariant: 'queen',  rarity: 'rare', inRewardPool: false, image: './img/Chess_qlt60.png', desc: 'Move like {queen}.' },
  ...
  { id: 'knight_power', name: 'Knight Power',   type: 'action', actionType: 'knight_power', rarity: 'common', image: './img/Chess_nlt60.png', desc: 'Apply {knight power}: can move like a {knight}. Lasts 1 move.' },
  { id: 'bishop_power', name: 'Bishop Power',   type: 'action', actionType: 'bishop_power', rarity: 'uncommon', image: './img/Chess_blt60.png', desc: 'Apply {bishop power}: can move like a {bishop}. Lasts 1 move.' },
  { id: 'rook_power',   name: 'Rook Power',     type: 'action', actionType: 'rook_power', rarity: 'uncommon', image: './img/Chess_rlt60.png', desc: 'Apply {rook power}: can move like a {rook}. Lasts 1 move.' },
  { id: 'queen_power',  name: 'Queen Power',    type: 'action', actionType: 'queen_power', rarity: 'rare', image: './img/Chess_qlt60.png', desc: 'Apply {queen power}: can move like a {queen}. Lasts 1 move.' },
  { id: 'king_power',   name: 'King Power',     type: 'action', actionType: 'king_power', rarity: 'rare', image: './img/Chess_klt60.png', desc: 'Apply {king power}: can move like a {king}. Lasts 1 move.' },
...
export const CARD_FACTORY_KEYS = {
  ...
  snap:        'snapCard',
  knight_power:'knightPowerCard',
  bishop_power:'bishopPowerCard',
  rook_power:  'rookPowerCard',
  queen_power: 'queenPowerCard',
  king_power:  'kingPowerCard',
  blitz:       'blitzCard',
